...
% Jay Dennis, Feb 2016
%--------------------------------------------------------------------
% PURPOSE: output a data table to latex format (.tex)
%--------------------------------------------------------------------
...
% must create the output directory if it does not exist.  Also, if you are
% running Windows instead of Linux then you may need to
% change the '/' to '\\' in the fname variable.  Update: It works on both
% Ubuntu 14.04 and Windows 8.1, 10
% --------------------------------------------------------------------
% EXAMPLE:
